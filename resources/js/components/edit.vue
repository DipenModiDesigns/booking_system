<template>
    <div class="container py-5">
        ...
        <form class="mainForm mx-auto card p-4" style="max-width: 700px;" @submit.prevent="updateBooking">
            <div class="title text-center mb-2">
                <h2>Edit Booking</h2>
            </div>
             <div class="mb-3">
                <label for="name" class="form-label">Name <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="name" placeholder="Name" v-model="bookings.name">
                <span v-if="errorMsgs.name" v-text="errorMsgs.name[0]" class="text-danger block w-100"></span>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email address <span class="text-danger">*</span></label>
                <input type="email" class="form-control" id="email" placeholder="name@example.com" v-model="bookings.email">
            ...
            <div class="mb-3 d-flex">
                ...
                <div class="form-check ms-5">
                    <input class="form-check-input" type="radio" name="booking_type" id="fullday" value="fullday" v-model="bookings.booking_type">
                    <label class="form-check-label" for="fullday">
                        Full day
                    </label>
                </div>
                <div class="form-check ms-4">
                    <input class="form-check-input" type="radio" name="booking_type" id="halfday" value="halfday" v-model="bookings.booking_type">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="booking_date" placeholder="Booking Date" min="2023-12-23" v-model="bookings.booking_date">
            ...
            <div class="mb-3 d-flex">
                ...
                <div class="form-check ms-5">
                    <input class="form-check-input" type="radio" name="booking_slot" id="morning" value="morning" v-model="bookings.booking_slot">
                    <label class="form-check-label" for="morning">
                        Morning
                    </label>
                </div>
                <div class="form-check ms-4">
                    <input class="form-check-input" type="radio" name="booking_slot" id="evening" value="evening" v-model="bookings.booking_slot">
             ...
             <div class="mb-3">
                ...
                <input type="time" class="form-control" id="booking_time" placeholder="Booking Time" v-model="bookings.booking_time">
                <span v-if="errorMsgs.booking_time" v-text="errorMsgs.booking_time[0]" class="text-danger block w-100"></span>
            </div>
            <button type="submit" class="btn btn-primary" :disabled="!bookings.id">Submit</button>
        </form>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            updateBooking() {
                axios
                    .patch(`api/booking/${this.$route.params.id}`, this.bookings)
                    .then(()=> {
